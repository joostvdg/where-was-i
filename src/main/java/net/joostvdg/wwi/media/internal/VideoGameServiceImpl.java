...
public class VideoGameServiceImpl implements VideoGameService {
  ...
  public VideoGame addVideoGame(VideoGame videoGame) {
    ...
    VideoGamesRecord newVideoGameRecord =
        create
            .insertInto(Tables.VIDEO_GAMES)
  ...
  public Optional<VideoGame> findVideoGameById(int id) {
    VideoGamesRecord videoGamesRecord =
        create.selectFrom(Tables.VIDEO_GAMES).where(Tables.VIDEO_GAMES.ID.eq(id)).fetchOne();
  ...
  public void updateVideoGame(VideoGame videoGame) {
    ...
    VideoGamesRecord foundRecord =
        create
            .selectFrom(Tables.VIDEO_GAMES)
            .where(Tables.VIDEO_GAMES.ID.eq(videoGame.id()))
            .fetchOne();
    if (foundRecord == null) {
  ...
  public Media translateViewRecordToVideoGame(Record watchListViewMediaRecord) {
    ...
    Set<String> genre =
        Arrays.stream(watchListViewMediaRecord.get("genre", String[].class))
